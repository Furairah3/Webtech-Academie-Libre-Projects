...
<link rel="stylesheet" href="<?= ASSETS_URL ?>/css/course-view.css?v=<?= time(); ?>">
...
<div class="course-view-container">
    ...
    <div class="course-view-layout">
        ...
        <aside class="course-view-sidebar">
            <div class="card">
                <h3>Quick Actions</h3>
                <a href="<?= BASE_URL ?>/course.php" style="display:block;margin:15px 0;color:#06b6d4;font-weight:600;">
                    ← Back to All Courses
                </a>
            </div>
            <div class="card">
                        ...
                        <div class="module-card <?php echo !$unlocked ? 'locked' : ''; ?>">
                            ...
                            <div class="module-card-body">
                                ...
                                <?php if($module['quiz_id'] && $unlocked): ?>
                                    <a href="<?= BASE_URL ?>/take-quiz.php?module_id=<?php echo $module['id']; ?>" 
                                ...
                                <?php if($module['assignment_id'] && $unlocked): ?>
                                    <a href="<?= BASE_URL ?>/upload-assignment.php?module_id=<?php echo $module['id']; ?>" 
                                       class="module-status status-assignment">
                                       Assignment Posted
                                    </a>
                                <?php endif; ?>

                                <a href="<?= BASE_URL ?>/module-view.php?id=<?php echo $module['id']; ?>" 
