...
showRegister.addEventListener('click', (e) => {
  e.preventDefault(); /*prevent the default link behavior, which would reload the page*/
...
// clears all error messages and removes error styling from the input fields when switching between Login and Register forms so that old errors do not stay on the screen.
